...
//this for the contact form
	...
	$result=$db_obj->create('contact_us', $formdata, $exclude = array('table','action','returnUrl','requiredFields','error','_wysihtml5_mode'));
	...
	if($result){
		...
		$title = "Data Direct | Contact Us";
		$message = "Someone left a message on the website, please check the system for more details. " ;
		...
		header("Location:".BASE_URL."contact-us/$s_data");
		exit;
	}else{
